...
public class MediumParkTest {

    @Test
    @DisplayName("GreenSpace Is Created Successfully")
    void ensureGreenSpaceIsCreatedSuccessfully() {
       new MediumPark("Jardim Porto",3,"street Porto",12,"1234-123","Porto");
    }

    @Test
    @DisplayName("Has Same Name")
    void ensureHasSameNameSuccessfully() {
        GreenSpace park = new MediumPark("Jardim Porto",3,"street Porto",12,"1234-123","Porto");
    ...
    void ensureInvalidAddressPostCode() {
        ...
        assertThrows(IllegalArgumentException.class,
                () ->new MediumPark("Jardim Porto",3,"street Porto",12,"1234-12","Porto"));
        assertThrows(IllegalArgumentException.class,
                () ->new MediumPark("Jardim Porto",3,"street Porto",12,"123-122","Porto"));
        assertThrows(IllegalArgumentException.class,
                () ->new MediumPark("Jardim Porto",3,"street Porto",12,"123412","Porto"));
    }
    ...
    void ensureInvalidArea() {
        ...
        assertThrows(IllegalArgumentException.class,
                () ->new MediumPark("Jardim Porto",0,"street Porto",12,"1234-12","Porto"));
        assertThrows(IllegalArgumentException.class,
                () ->new MediumPark("Jardim Porto",-1,"street Porto",12,"1234-12","Porto"));
    }
    ...
    void testEqualsDifferentObject() {
        GreenSpace park = new MediumPark("Jardim Porto",3,"street Porto",12,"1234-123","Porto");
        GreenSpace park1 = new MediumPark("Jardim Lisboa",3,"street Porto",12,"1234-123","Porto");
    ...
    void testEqualsSameObjectSame() {
        GreenSpace park = new MediumPark("Jardim Porto",3,"street Porto",12,"1234-123","Porto");
        GreenSpace park1 = new MediumPark("Jardim Porto",3,"street Porto",12,"1234-123","Porto");
