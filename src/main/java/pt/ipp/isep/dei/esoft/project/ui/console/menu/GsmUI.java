...
public class GsmUI implements Runnable {
    ...
    public void run() {
        ...
        options.add(new MenuItem("US22 - Add New Entry Agenda.", new AddNewEntryToAgendaUI()));
        options.add(new MenuItem("US23 - Assign Team To Entry Agenda.", new AssignTeamAgendaUi()));
